export const fetchImages = async (visionBoardId) => {
  return fetch(
    `http://localhost:8080/api/images/visionboard/${visionBoardId}`
...
export const updateImageBorderRadius = async (id, image) => {
  return fetch(
    `http://localhost:8080/api/images/${id}/updateImageBorderRadius`,
    {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
...
export const updateImageParentElement = async (id, image) => {
  return fetch(
    `http://localhost:8080/api/images/${id}/updateImageParentElement`,
    {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
